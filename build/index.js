...
server.tool("getOpenAPISpec", "Obtenir la spécification OpenAPI de l'api tiers sur le serveur SPO. Les apis sont compatible avec un sous-set odata pour l'intérogation. Il ne faut pas utiliser $filter sur les sous-entites. La reponse est en format json.", {}, async () => {
    try {
